...
<!-- Login Form BEGIN -->
<div class="dajo_mantis_bug_tracker_title"><?php echo lang_get( 'dajo_mantis_bug_tracker_title' ) ?></div>
<br />
<div align="center" class="dajo-loginform">
<form name="login_form" method="post" action="login.php">
<?php # CSRF protection not required here - form does not result in modifications ?>
<table class="width50" cellspacing="0" cellpadding="0">
<tr>
	<td class="form-title">
		<?php
			if ( !is_blank( $f_return ) ) {
...
<div class="dajo-loginform-links">
  <?php
